...
static void colorEvent(lv_event_t* e) {
    ...
    colorSet(allianceColor, allianceInd);
    if (allianceColor == RED) chassis.setPose(chassis.getPose().x, chassis.getPose().y, chassis.getPose().theta + 90);
    if (allianceColor == BLUE) chassis.setPose(chassis.getPose().x, chassis.getPose().y, chassis.getPose().theta + 180);
    if (allianceColor == NONE) chassis.setPose(chassis.getPose().x, chassis.getPose().y, chassis.getPose().theta - 270);
    resetViewer(true);
