...
AutonFunction autonFunctions[] = {
    ...
    {"Solo AWPs Left", soloAwpLeft},
    {"Solo AWPs Right", soloAwpRight},
    {"Left Red", leftRed},
    {"Left Blue", leftBlue},
    {"Right Red", rightRed},
    ...
    {"Drive and Turn Example", drive_and_turn},
    {"Wait Until Change Speed Example", wait_until_change_speed},
    {"Swing Example", swing_example},
    {"Motion Chaining Example", motion_chaining},
    {"Combining Movements Example", combining_movements},
...
void initialize() {
  ...
  initAll();  // Initialize all subsystems
